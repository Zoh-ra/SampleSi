  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleSiApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleSiApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('sampleSiApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('sampleSiApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('sampleSiApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('sampleSiApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('sampleSiApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
