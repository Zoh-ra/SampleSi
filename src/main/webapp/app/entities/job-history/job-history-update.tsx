  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleSiApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleSiApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('sampleSiApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('sampleSiApp.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('sampleSiApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('sampleSiApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
