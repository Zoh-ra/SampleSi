  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleSiApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleSiApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('sampleSiApp.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('sampleSiApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('sampleSiApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('sampleSiApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
